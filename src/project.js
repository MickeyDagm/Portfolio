...
const projects = [
    ...
    {id: 3, name: 'Recipes Hub', description: "A recipe-sharing website with a modern design, showcasing various recipes and providing an intuitive user experience for discovering and exploring new dishes.", image: recipesHub, link:'',sourceCodeLink:'https://github.com/MickeyDagm/Portfolio', likes:0},
]
